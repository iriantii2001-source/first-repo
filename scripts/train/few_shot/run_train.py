...
parser.add_argument('--data.split', type=str, default=default_split, metavar='SP',
                    help="split name, only used by the omniglot dataset (default: {:s})".format(default_split))
...
parser.add_argument('--data.test_way', type=int, default=2, metavar='TESTWAY',
                    help="number of classes per episode in test. 0 means same as data.way (default: 2)")
...
parser.add_argument('--data.test_query', type=int, default=10, metavar='TESTQUERY',
                    help="number of query examples per class in test. 0 means same as data.query (default: 10)")
